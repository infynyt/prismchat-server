...
public class Path extends haxe.lang.HxObject
{
	...
	public static java.lang.String join(haxe.root.Array<java.lang.String> paths)
	{
		...
		//line 191 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		if (( paths1.length == 0 )) 
		{
		...
		//line 195 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		{
			...
			while (( _g2 < _g3 ))
			{
				//line 195 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
				int i1 = _g2++;
				//line 196 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
	...
	public static java.lang.String normalize(java.lang.String path)
	{
		...
		//line 212 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		...
		//line 218 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		{
			...
			while (( _g < _g1.length ))
			{
				...
				//line 218 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
				 ++ _g;
				//line 219 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
				...
				{
					//line 221 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
					...
					{
						//line 225 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
						if ( ! (haxe.lang.Runtime.valEq(token, ".")) ) 
						{
		...
		//line 231 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		haxe.root.StringBuf acc = new haxe.root.StringBuf();
		//line 232 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		boolean colon = false;
		//line 233 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		...
		//line 235 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		{
			...
			while (( _g2_offset < _g2_s.length() ))
			{
				...
				//line 235 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
				int c2 = c1;
				//line 236 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
				switch (c2)
				{
					case 47:
					{
						...
						else
						{
							...
							//line 246 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
							{
								...
								colon = false;
								//line 248 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
								if (slashes) 
								{
									...
									//line 250 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
									slashes = false;
								}
					...
					case 58:
					{
						...
						//line 243 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
						colon = true;
	...
	public static java.lang.String addTrailingSlash(java.lang.String path)
	{
		...
		//line 275 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
		...
		{
			//line 282 "C:\\HaxeToolkit\\haxe\\std\\haxe\\io\\Path.hx"
			if (( c1 != ( path.length() - 1 ) )) 
			{
