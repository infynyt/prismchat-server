...
public class HaxeThread extends haxe.lang.HxObject
{
	static
	{
		//line 89 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		{
			//line 90 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
			...
			//line 91 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
			sys.thread._Thread.HaxeThread.mainJavaThread = java.lang.Thread.currentThread();
			//line 92 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
			sys.thread._Thread.HaxeThread.mainHaxeThread = new sys.thread._Thread.HaxeThread();
			//line 93 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
	...
	public HaxeThread()
	{
		//line 144 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
	...
	{
		//line 101 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		sys.thread._Thread.HaxeThread hx = new sys.thread._Thread.HaxeThread();
		//line 102 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		if (withEventLoop) 
		{
			//line 103 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
			hx.events = new sys.thread.EventLoop();
		}
		
		//line 104 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		...
		//line 105 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		thread.setDaemon(haxe.lang.Runtime.toBool(((java.lang.Boolean) (true) )));
		//line 106 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		thread.start();
		//line 107 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		return hx;
	}
	...
	{
		//line 111 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		if (( javaThread == sys.thread._Thread.HaxeThread.mainJavaThread )) 
		{
			//line 112 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
			return sys.thread._Thread.HaxeThread.mainHaxeThread;
		}
		else
		{
			//line 113 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
			if (haxe.root.Std.isOfType(javaThread, sys.thread._Thread.NativeHaxeThread.class)) 
			{
				//line 114 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
				return ((sys.thread._Thread.NativeHaxeThread) (javaThread) ).haxeThread;
			}
			else
			{
				//line 116 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
				sys.thread._Thread.HaxeThread _g = sys.thread._Thread.HaxeThread.nativeThreads.get(((java.lang.Object) (javaThread) ));
				//line 117 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
				if (( _g == null )) 
				{
					//line 118 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
					sys.thread._Thread.HaxeThread hx = new sys.thread._Thread.HaxeThread();
					//line 119 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
					sys.thread._Thread.HaxeThread.nativeThreads.put(((java.lang.Thread) (javaThread) ), ((sys.thread._Thread.HaxeThread) (hx) ));
					//line 120 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
					return hx;
				}
				else
				{
					//line 121 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
					sys.thread._Thread.HaxeThread hx1 = _g;
					//line 122 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
					return hx1;
				}
	...
	{
		//line 84 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		{
			//line 84 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
