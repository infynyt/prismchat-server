...
public final class Thread_Impl_
{
	...
	{
		//line 73 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		if (( this1.events == null )) 
		{
			//line 74 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
			throw new sys.thread.NoEventLoopException(haxe.lang.Runtime.toString(null), ((haxe.Exception) (null) ));
		}
		
		//line 75 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
		return this1.events;
	}
	...
	{
		//line 80 "/usr/share/haxe/std/java/_std/sys/thread/Thread.hx"
