...
public class Socket extends haxe.lang.HxObject
{
	...
	public Socket()
	{
		//line 38 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
	...
	public void create()
	{
		//line 43 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		this.sock = new java.net.Socket();
		//line 45 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		try 
		{
			//line 45 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		...
		{
			//line 46 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
	...
	public void close()
	{
		//line 51 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		try 
		{
			//line 52 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			if (( this.sock != null )) 
			{
				//line 53 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
				this.sock.close();
			}
	...
	public void listen(int connections)
	{
		...
		{
			//line 82 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			java.lang.Object e = ((java.lang.Object) (haxe.Exception.caught(_g).unwrap()) );
			//line 83 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			throw ((java.lang.RuntimeException) (haxe.Exception.thrown(e)) );
		}
	...
	{
		//line 104 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		try 
		{
			//line 105 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			...
			//line 107 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			sys.net.Socket s = new sys.net.Socket();
			//line 108 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			s.sock = ret;
			//line 109 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			s.output = new haxe.java.io.NativeOutput(((java.io.OutputStream) (ret.getOutputStream()) ));
			//line 110 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			s.input = new haxe.java.io.NativeInput(((java.io.InputStream) (ret.getInputStream()) ));
			//line 112 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
			return s;
		}
	...
	{
		//line 28 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
		{
			//line 28 "/usr/share/haxe/std/java/_std/sys/net/Socket.hx"
